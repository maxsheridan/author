...
#
# USAGE:
#   ./run_css.sh assets/css/style.css assets/css/critical.css assets/css/style.min.css index.html
#
...
echo "Usage: $0 <style.css> <critical.css> <style.min.css> <index.html>"
exit 1
fi
...
python3 "$SCRIPT_DIR/assets/py/sync_extra_min_css.py" "$STYLE_MIN_CSS" "$SCRIPT_DIR/assets/css/extra.min.css"
