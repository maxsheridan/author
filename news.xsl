  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        ...
        <style>.rss-item + .rss-item{margin-block-start:var(--space-1)}hr.rss{margin-block-start:var(--space-2);margin-block-end:var(--space-2)}p.pub-date{color:rgb(var(--accent))}</style>
